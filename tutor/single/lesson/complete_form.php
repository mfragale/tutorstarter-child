...
?>
	<div class="tutor-topbar-complete-btn tutor-mr-20">
		<form method="post">
			...
			<!-- <button type="submit" class="tutor-topbar-mark-btn tutor-btn tutor-btn-primary tutor-ws-nowrap" name="complete_lesson_btn" value="complete_lesson">
				<span class="tutor-icon-circle-mark-line tutor-mr-8" area-hidden="true"></span>
				<span><?php // esc_html_e('Mark as Complete', 'tutor'); 
						?></span>
			</button> -->
			<!-- Nova College MODIFIED -->
